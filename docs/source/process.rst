...
5. **Classification**: Output is assigned as one of of forecast bins based on the nationwide binning thresholds. 
...
Low is defined as the lowest 65% of probabilities, Moderate is defined as the next 25% of probabilities, and Considerable is defined as the top 10% of probabilities. 
