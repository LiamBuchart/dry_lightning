""" 
    ...
    Similar to png_plot_validate but for categorical plots.
    Will create a 2 week historgram and a annual histogram (from start of season).
    Then will also plot similar timeseries of the accuracy, heidke skill score, and the hanssen-kuipers discriminant score.
...
def plot_metrics(stats_long):
    ...
    for metric in STATS_COLUMNS:
        ...
        out_file = PLOTS_DIR / f"cat_{metric.lower()}_timeseries.png"
...
def main():
    ...
    for label, ndays in {"full_season": 200, "last_14_days": 14}.items():
