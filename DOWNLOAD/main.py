...
#%%
##### USER INPUT #####  # need to do 25
station_select = "INUVIK+UA"  #all_stations[28]  # e.g., "Port Hardy"
...
for year in years:
    ...
    if point_in_shapefile(shapefile_path=census_shapefile, lat=lat, lon=lon, buffer_km=0):
